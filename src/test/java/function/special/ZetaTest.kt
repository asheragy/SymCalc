...
internal class ZetaTest {
    ...
    fun zeta7() {
        repeat(1600) {
            Zeta(Integer(7).toPrecision(100)).eval() `should equal` "1.008349277381922826839797549849796759599863560565238706417283136571601478317355735346096968913851324"
        }
    }
    ...
    fun zeta13() {
        repeat(200) {
            Zeta(Integer(13).toPrecision(100)).eval() `should equal` "1.000122713347578489146751836526357395714275105895509845136702671620896726829844209812892713953268136"
        }
    }
    ...
    fun zeta15() {
        repeat(1) {
            Zeta(Integer(15).toPrecision(100)).eval() `should equal` "1.000030588236307020493551728510645062587627948706858177506569932893332267156342279573072334347017548"
        }
    }
    ...
    fun zeta99() {
        repeat(1) {
            Zeta(Integer(99).toPrecision(100)).eval() `should equal` "1.000000000000000000000000000001577721810442023616644432783015960178223709238624152775914274573141831"
        }
    }
