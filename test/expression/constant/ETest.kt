...
class ETest {
    ...
    fun basic() {
        ...
        assertEquals(RealNum.create("2.7182818284590452353602874713526624977572470936999595749669676277240766303535475945713821785251664274"), N(E(), IntegerNum(100)).eval())
    }
}