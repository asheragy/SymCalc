...
class FunctionExprTest {
    @Test
    fun equals() {
        val f1 = Plus(IntegerNum(3), RealDouble(5.0))
        val f2 = Subtract(IntegerNum(3), RealDouble(5.0))
        val f3 = Plus(IntegerNum(4), RealDouble(5.0))
        val f4 = Plus(IntegerNum(3), RealDouble(5.0)) // same as f1
